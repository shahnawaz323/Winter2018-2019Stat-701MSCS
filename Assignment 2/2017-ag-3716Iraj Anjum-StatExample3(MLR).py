...
print("X1=(number of students(passed the courses) , X2=number of teachers , Y=yearly profit(%)")
...
print("3rdly calculate (sigmax1.y.sigmax1.x2)")
ptt2=Sumx1y*Sumx1x2
...
print("This is the 2nd Assignment(example.3)of Stat701 in python.Thanku for watching :)")

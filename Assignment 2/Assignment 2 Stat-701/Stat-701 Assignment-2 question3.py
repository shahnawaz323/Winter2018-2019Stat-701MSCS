...
def main():
    # observations
    x1 = np.array([80, 100, 120, 150, 200])
    # X1 is a Space (kbps) that occupy by line of code
    x2 = np.array ([10, 30, 50, 70, 80])
    # X2 is a Time (Sec) that consume to run the line of code
    y = np.array([30, 40, 50, 60, 70])
    # Y is a line of code that depends on Space and Time
